...
def csv2dict(anno_path, dataset_type):
    ...
    info_dict = dict()
    info_dict['prefix'] = anno_path.rsplit("/", 3)[0] + "/features/fullFrame-640x480px"
...
def resize_img(img_path, dsize='640x480px'):
...
def resize_dataset(video_idx, dsize, info_dict):
    ...
    for img_path in img_list:
        ...
        rs_img_path = img_path.replace("640x480px", dsize)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Data process for TSL dataset.')
    parser.add_argument('--dataset', type=str, default='TSL',
                        help='save prefix')
    parser.add_argument('--dataset-root', type=str, default='/root/workspace/Dataset/TSL',
